...
require ('../../fpdf/fpdf.php');
	...
	class PDF extends FPDF{
		function Header(){
			...
			$this -> Cell(0,9,'UNPAID TAXES BUSINESS LISTS',0,1,"C");
	...
	$q = "SELECT * FROM businesses where bs_id NOT IN (SELECT bs_id FROM tax_payments WHERE  tax_yr='".$_GET['yr']."' AND tax_period='".$_GET['month']."' GROUP BY bs_id)";
